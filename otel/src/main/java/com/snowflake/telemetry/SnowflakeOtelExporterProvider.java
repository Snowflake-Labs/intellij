...
public class SnowflakeOtelExporterProvider implements OpenTelemetryExporterProvider {
    ...
    private MetricExporter createMetricExporter() {
        String endpoint = System.getProperty("idea.diagnostic.opentelemetry.otlp", "http://localhost:4317") + "/v1/metrics";
        String metricNamePrefix = System.getProperty("sf.otlp.metric.prefix", "sfide_");
